...
<body>
    ...
    <div class="rightinfo">
        <div class="tools">
            <ul class="toolbar">
                <a href=""><li><span><img src="/Public/Admin/img/t01.png" /></span>添加</li></a>
        ...
        <table class="tablelist">
            ...
            <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                    <td>
                        <input name="check" type="checkbox" value="<?php echo ($v["role_id"]); ?>" />
                    </td>
                    <td><?php echo ($v["role_id"]); ?></td>
                    <td><?php echo ($v["role_name"]); ?></td>
                    <td><?php echo ($v["role_auth_ids"]); ?></td>
                    <td><?php echo ($v["role_auth_ac"]); ?></td>
                    <td><a href="/index.php/Admin/Role/setAuth/role_id/<?php echo ($v["role_id"]); ?>" class="tablelink">设置权限</a> <a href="/index.php/Admin/Role/del/role_id/<?php echo ($v["role_id"]); ?>" class="tablelink" onclick="return del()"> 删除</a></td>
    ...
    <script type="text/javascript">
        ...
        $('#dels').click(function(){
            ...
            location.href = "/index.php/Admin/Role/dels/id/"+ids;
        });
        function del(){
